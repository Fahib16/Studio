...
{
    /// <summary>
    /// Memeriksa keberadaan satu folder. Path kosong dianggap "tidak ada",
    ...
    /// </summary>
    [Designer(typeof(Design.FolderExistsDesigner), typeof(System.ComponentModel.Design.IDesigner))]
    [DisplayName("Folder Exists")]
    [Description("Mengecek apakah sebuah folder ada.")]
    [System.Drawing.ToolboxBitmap(typeof(ResFinder), "Resources.folderexists.png")]
    public sealed class FolderExists : CodeActivity
    {
        public FolderExists()
        {
            DisplayName = "Folder Exists";
        ...
        [RequiredArgument]
        [DisplayName("Path")]
        [Description("Folder yang mau dicek.")]
