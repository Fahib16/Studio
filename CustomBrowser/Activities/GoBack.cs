...
{
    /// <summary>
    /// Kembali ke halaman sebelumnya di riwayat tab.
    ///
    ...
    /// </summary>
    [Designer(typeof(Design.GoBackDesigner), typeof(System.ComponentModel.Design.IDesigner))]
    [DisplayName("Go Back")]
    [Description("Kembali ke halaman sebelumnya di riwayat tab.")]
    [System.Drawing.ToolboxBitmap(typeof(ResFinder), "Resources.goback.png")]
    public sealed class GoBack : CodeActivity
    {
        public GoBack()
        {
            DisplayName = "Go Back";
