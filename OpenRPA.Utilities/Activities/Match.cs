...
{
    [Designer(typeof(MatchDesigner), typeof(System.ComponentModel.Design.IDesigner))]
    //[designer.ToolboxTooltip(Text = "Find an Windows UI element based on xpath selector")]
    [System.Drawing.ToolboxBitmap(typeof(ResFinder), "Resources.jf_match.png")]
    public class Match : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var ma = Regex.Match(Input.Get(context), Pattern.Get(context), options);
            Result.Set(context, ma.Success);
        }
